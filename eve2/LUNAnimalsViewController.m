...
- (void)contentSetup {
    self.titles = @[@"TOMORROW STARTS TODAY",
                    @"SET YOUR WAKE TIME",
                    @"EVE WILL REMIND YOU"];
    
    self.texts = @[@"Life is good after a great night's sleep. Eve Alarm sends you a reminder at the best time for you to settle down.",
...
- (__kindof UIView *)labelViewAtIndex:(NSInteger)index {
    ...
    [labelsView setupTitle:self.titles[index] supportingText:self.texts[index] titleColor:[UIColor whiteColor] textColor:[UIColor colorWithRed:0.96f green:0.96f blue:0.96f alpha:1.0f]];
    labelsView.titleLabel.font = [UIFont fontWithName:@"Nunito-Bold" size:20];
    labelsView.textLabel.font = [UIFont fontWithName:@"Nunito-Regular" size:15];
